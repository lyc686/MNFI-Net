...
def run(
    ...
    if save_json and len(jdict):
        ...
        anno_json = str(Path(data.get('path', '../coco')) / './gf_2153.json')  # annotations json
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='runs/train/ours/weights/best.pt', help='model path(s)')
