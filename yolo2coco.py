...
parser.add_argument('--root_dir', default='/home/zhangfeng/liuyuchen/yolov5-res2ghost/dataset/new_gf2173',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str,default='gf_2153.json', help="if not split the dataset, give a path to a json file")
